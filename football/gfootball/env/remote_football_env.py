...
from football.gfootball.eval_server import config
from football.gfootball.eval_server import utils
from football.gfootball.eval_server.proto import game_server_pb2
from football.gfootball.eval_server.proto import game_server_pb2_grpc
from football.gfootball.eval_server.proto import master_pb2
from football.gfootball.eval_server.proto import master_pb2_grpc
...
class RemoteFootballEnv(gym.Env):
    def __init__(self, username, token, model_name='', track='default', include_rendering=False):
