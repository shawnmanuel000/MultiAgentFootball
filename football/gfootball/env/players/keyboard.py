...
KEY_TO_ACTIONS = {
    pygame.K_s: [football_action_set.action_short_pass, football_action_set.action_pressure],
    pygame.K_d: [football_action_set.action_shot, football_action_set.action_team_pressure],
    pygame.K_a: [football_action_set.action_high_pass, football_action_set.action_sliding],
    pygame.K_w: [football_action_set.action_long_pass, football_action_set.action_keeper_rush],
