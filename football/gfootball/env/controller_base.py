...
class Controller(player_base.PlayerBase):
    ...
    def _check_action(self, action, active_actions):
        ...
        if (self._last_action == football_action_set.action_idle and self._active_actions.get(action, 0) != state):
    ...
    def get_env_action(self, left, right, top, bottom, active_actions):
        ...
        """
        self._current_direction = football_action_set.action_idle
        self._check_direction(football_action_set.action_top_left, top and left)
        self._check_direction(football_action_set.action_top_right, top and right)
        self._check_direction(football_action_set.action_bottom_left, bottom and left)
        self._check_direction(football_action_set.action_bottom_right, bottom and right)
        if self._current_direction == football_action_set.action_idle:
        ...
        self._last_action = football_action_set.action_idle
        self._check_action(football_action_set.action_long_pass, active_actions)
        self._check_action(football_action_set.action_high_pass, active_actions)
        self._check_action(football_action_set.action_short_pass, active_actions)
        self._check_action(football_action_set.action_shot, active_actions)
        self._check_action(football_action_set.action_keeper_rush, active_actions)
        self._check_action(football_action_set.action_sliding, active_actions)
        self._check_action(football_action_set.action_pressure, active_actions)
        self._check_action(football_action_set.action_team_pressure, active_actions)
