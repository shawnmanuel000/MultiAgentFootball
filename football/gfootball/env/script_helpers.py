...
class ScriptHelpers(object):
    ...
    def __modify_trace(self, replay, fps):
        ...
        for f in replay:
            ...
            idle_step['debug']['action'] = [football_action_set.action_idle] * len(f['debug']['action'])
    ...
    def replay(self, dump, fps=10, config_update={}, directory=None, render=True):
        ...
        assert replay[0]['debug']['frame_cnt'] == 1, ('Trace does not start from the beginning of the episode, can not replay')
