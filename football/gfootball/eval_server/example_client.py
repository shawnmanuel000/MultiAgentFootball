...
def main(unused_argv):
    ...
    env = football_env.create_remote_environment(FLAGS.username, FLAGS.token, FLAGS.model_name, track=FLAGS.track, representation='extracted', stacked=True, include_rendering=FLAGS.render)
